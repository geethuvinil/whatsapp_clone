...
class _ChatDetailsScreenState extends State<ChatDetailsScreen> {
  List<Singlechat>messageList = [
    Singlechat(isSend: true, isReaded: true, message: "INDIA", sendAt: "5:15 PM"),
    Singlechat(isSend: false, isReaded: false, message: "KERALA", sendAt: "10:10 AM"),
    Singlechat(isSend: true, isReaded: false, message: "Thrissur", sendAt: "3:09 AM"),
